...
void SceneFog::initScene()
{
    ...
    view = glm::lookAt(vec3(0.0f,4.0f,6.0f), vec3(5.0f,5.0f,0.0f), vec3(0.0f,-1.0f,0.0f));
...
{
    if( ! prog.CompileShaderFromFile("../ConsoleApplication1/Shader/fog.vs",GLSLShader::VERTEX) )
    {
        printf("Vertex shader failed to compile!\n%s",
               prog.Log().c_str());
        exit(1);
    }
    if( ! prog.CompileShaderFromFile("../ConsoleApplication1/Shader/fog.fs",GLSLShader::FRAGMENT))
    {
