...
{
    if( ! prog.CompileShaderFromFile("../ConsoleApplication1/Shader/sky.vs",GLSLShader::VERTEX) )
    {
        printf("Vertex shader failed to compile!\n%s",
               prog.Log().c_str());
        exit(1);
    }
    if( ! prog.CompileShaderFromFile("../ConsoleApplication1/Shader/sky.fs",GLSLShader::FRAGMENT))
    {
