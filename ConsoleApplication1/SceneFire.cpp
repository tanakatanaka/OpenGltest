...
{    
    ...
    const char * texName = "../ConsoleApplication1/texture/fire.png";
...
void SceneFire::resize(int w, int h)
{
	...
	projection = glm::perspective(300.0f, (float)width/height, 0.3f, 2000.0f);
}

void SceneFire::compileAndLinkShader()
{
    if( ! prog.CompileShaderFromFile("../ConsoleApplication1/Shader/fire.vs",GLSLShader::VERTEX) )
    {
        printf("Vertex shader failed to compile!\n%s",
               prog.Log().c_str());
        exit(1);
    }
    if( ! prog.CompileShaderFromFile("../ConsoleApplication1/Shader/fire.fs",GLSLShader::FRAGMENT))
    {
