...
{    
    ...
    const char * texName = "../ConsoleApplication1/Texture/bluewater.png";
...
{
    if( ! prog.CompileShaderFromFile("../ConsoleApplication1/Shader/transfeedback.vs",GLSLShader::VERTEX) )
    {
        printf("Vertex shader failed to compile!\n%s",
               prog.Log().c_str());
        exit(1);
    }
    if( ! prog.CompileShaderFromFile("../ConsoleApplication1/Shader/transfeedback.fs",GLSLShader::FRAGMENT))
    {
