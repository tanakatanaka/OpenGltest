...
{
    if( ! prog.CompileShaderFromFile("../ConsoleApplication1/Shader/bezcurve.vs",GLSLShader::VERTEX) )
    {
        printf("Vertex shader failed to compile!\n%s",
               prog.Log().c_str());
        exit(1);
    }
    if( ! prog.CompileShaderFromFile("../ConsoleApplication1/Shader/bezcurve.fs",GLSLShader::FRAGMENT))
    {
    ...
    if( ! prog.CompileShaderFromFile("../ConsoleApplication1/Shader/bezcurve.tcs",GLSLShader::TESS_CONTROL))
    {
