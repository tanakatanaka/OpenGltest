...
void SceneRenderToTex::renderToTexture() {
    ...
    projection = glm::perspective(200.0f, 1.0f, 0.3f, 1000.0f);
...
{
    if( ! prog.CompileShaderFromFile("../ConsoleApplication1/Shader/rendertotex.vs",GLSLShader::VERTEX) )
    {
        printf("Vertex shader failed to compile!\n%s",
               prog.Log().c_str());
        exit(1);
    }
    if( ! prog.CompileShaderFromFile("../ConsoleApplication1/Shader/rendertotex.fs",GLSLShader::FRAGMENT))
    {
